...
package and manual.
** TODO Installing org-trello using Package (recommended)
:PROPERTIES:
:ALT_TITLE: Installing
:DESCRIPTION: Recommended Installation
:END:
#+CINDEX: org-trello, installing
*** TODO Using MELPA with Package
:PROPERTIES:
:ALT_TITLE: About MELPA
...
*** TODO Installing from MELPA with Package
:PROPERTIES:
...
#+INCLUDE: README.org
** CHEK Migrating to New Releases
:PROPERTIES:
:CUSTOM_ID: migration
:ALT_TITLE: Migrating
...
** CHEK Customizing org-trello Variables
:PROPERTIES:
:ALT_TITLE: Variables
...
** CHEK Example Emacs-Lisp Customization
:PROPERTIES:
:ALT_TITLE: Example
...
** CHEK Automatic org-trello Files
:PROPERTIES:
...
** CHEK Continuous Integration Tests
:PROPERTIES:
:ALT_TITLE: CI Tests
