...
(expectations
  (desc "orgtrello-api/delete-card")
...
(expectations
  (desc "orgtrello-api/add-card - name, idList, due-date")
...
(expectations
  (desc "orgtrello-api/add-card - name, idList, due-date, idMember")
...
(expectations
  (desc "orgtrello-api/add-card - name, idList, description")
...
(expectations
  (desc "orgtrello-api/add-card - name, idList, labels")
...
(expectations
  (desc "orgtrello-api/move-card - card-id, list-id, name")
...
(expectations
  (desc "orgtrello-api/move-card - card-id, list-id")
...
(expectations
  (desc "orgtrello-api/move-card - card-id, list-id, no name, due date")
...
(expectations
  (desc "orgtrello-api/move-card - card-id, list-id, name, due-date")
...
(expectations
  (desc "orgtrello-api/move-card - card-id, list-id, name, no due-date, idMembers")
...
(expectations
  ...
  (expect '(("fields" . "name,pos,idCard") ("checkItem_fields" . "name,pos,state")) (gethash :params (orgtrello-api/get-checklist :checklist-id))))

(expectations
  (desc "orgtrello-api/get-checklist - no items required")
  (expect '(("checkItems" . "none") ("fields" . "name,pos,idCard") ("checkItem_fields" . "name,pos,state")) (gethash :params (orgtrello-api/get-checklist :checklist-id 'no-items))))

(expectations
  (desc "orgtrello-api/add-items - 1")
...
(expectations
  (desc "orgtrello-api/add-items - 2")
...
(expectations
  (desc "orgtrello-api/add-items - 3")
...
(expectations
  (desc "orgtrello-api/update-item - 1")
...
(expectations
  ...
  (expect '(("fields" . "name,pos,state"))                (gethash :params (orgtrello-api/get-item :checklist-id :item-id))))

(expectations
  (desc "orgtrello-api/get-me")
  (expect "GET"         (gethash :method (orgtrello-api/get-me)))
  (expect "/members/me" (gethash :uri (orgtrello-api/get-me))))

(expectations
  (desc "orgtrello-api/--deal-with-optional-value")
...
(expectations
  (desc "orgtrello-api/--deal-with-optional-values")
