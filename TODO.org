...
* TODO v0.0.3 (or idea box or wish list or whatever)
** TODO Create complex entities (does not work yet!)
...
** TODO Another way of setting up the org-mode file and the trello board by creating the board for example
This will ease the installation of the list-ids in top of the org file.
Workflow:
- M-x orgtrello-create-board - interactive command to create a board and the needed lists
#+begin_src txt
# +property: board-id      <board-id>
# +property: todo-list-id  <todo-list-id>
# +property: doing-list-id <doing-list-id>
...
** TODO Given a trello board, create a org-mode file
