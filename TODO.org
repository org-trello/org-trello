...
* IN-PROGRESS 0.5.3 [57%]
- [X] Backlog
- [-] Emacs blocks when sync - #164 - Deferred the sync/delete actions [83%]
  - [X] Align execution of code regarding
    - [X] Sync to
    - [X] Sync from
    - [X] Delete
  - [-] Render the execution asynchronous
    - [X] Delete
    - [ ] Sync to
    - [ ] Sync from
