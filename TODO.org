...
- [ ] `Trello archived` cards are not archived on org-trello buffers - https://github.com/org-trello/org-trello/issues/203
* IN-PROGRESS 0.6.0 [57%]
...
- [-] `Checklists don't work for me` - It does work - Need to improve checklist and item predicates. - https://github.com/org-trello/org-trello/issues/204
  - [X] Fix behavior
  - [ ] Fix tests
- [ ] Release notes
* DONE 0.5.9 [100%]
