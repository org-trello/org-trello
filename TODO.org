...
- [-] Invisible checkbox identifier - https://github.com/ardumont/org-trello/issues/98
  ...
  - [ ] When inserting marker (because data is not yet synced, this must be inside an overlay too)
  - [ ] When removing card, overlays present in the region of the card must disappear too.
  - [ ] When removing all org-trello data, overlays destruction!
  - [ ] Create a migration routine for existing buffer without overlay
- [ ] Release notes
- [ ] Update version
- [ ] Release
* TODO 0.3.0 [%]
