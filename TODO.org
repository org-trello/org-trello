...
** TODO Some refactoring on the sync from trello routine (2 reduce embedded, only one is sufficient)
** TODO Abstract away the return data from the http request
** TODO Release notes
* TODO 0.1.1
