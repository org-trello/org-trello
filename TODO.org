...
* IN-PROGRESS 0.5.4 [20%]
- [X] Backlog
- [-] Archive cards - [[https://github.com/org-trello/org-trello/issues/181][#181]]
  - [X] Open trello api about (un)archive card
  - [X] Refactor API to factorize behavior
  - [-] Install org-trello archive binding [60%]
    ...
    - [ ] Deal with card not synced first
    - [ ] Archive all cards interactive command
- [ ] Fix potential deferred problem version that triggers shitstorm during installation [[https://github.com/org-trello/org-trello/issues/192][#192]]
- [ ] Update version
- [ ] Release notes
* DONE 0.5.3 [100%]
