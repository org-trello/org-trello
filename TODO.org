...
- [ ] Fix sync-from-trello - if new entities are referenced but not yet sync on trello, they will disappear from the buffer when sync-from-trello - reference github issue
- [ ] Release notes
* TODO 0.2.4 [0%]
