...
** TODO The same way as before, ensure that before making the request, the needed data are ok (checklist needs the card id, the item needs the checklist id, etc...)
