...
* IN-PROGRESS development steps [89%] :orgtrello-id-51d18669dbb4f4076b001bde:
...
** TODO Adding org metadata file `a la` #+BOARD-ID, #+TODO-LIST-ID, #+DOING-LIST-ID, #+DONE-LIST-ID to permit the user to setup easily without touching lisp code
