...
** TODO No saving of the buffer at the end of the sync between org and trello as this avoid the user to see what's going on
** TODO Implement a simple checklist with the current implementation
** TODO A simple and parametrable setup to make the user choose to use the checklist system or not
* TODO v0.0.9 [%]
