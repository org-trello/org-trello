...
- [ ] Migrate ~/.trello/config.el inside emacs's home - #239
- [ ] Fix #250 - Changing order of checklist items not saved unless checklist item's text changed

* IN-PROGRESS 0.6.9.6 [100%]
- [X] Create backlog
- [X] Update version
