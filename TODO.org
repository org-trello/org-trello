...
- [X] Version
- [X] Release notes
- [X] Fix typography in naming windows-nt system - https://github.com/ardumont/org-trello/issues/62#issuecomment-24735681
* DONE 0.2.2 [100%]
...
- [-] Invisible checkbox identifier - https://github.com/ardumont/org-trello/issues/98
  ...
  - [ ] When removing card, overlays present in the card region must disappear too.
  - [ ] Create a migration routine to install overlays on org-trello checkbox
  - [ ] Reference the migration routine in the README.md
  - [ ] Ensure sync-from-trello routine works with overlays too.
- [ ] Extract a new namespace mode for the org-trello mode definition
- [ ] Release notes
- [ ] Update version
- [ ] Release
* TODO 0.3.0 [%]
- [ ] Clean the code regarding the old checklist/item entities (with stars)
- [ ] Improve the upgrading version way (writed at 2 places, 1 is better to avoid duplication)
- [ ] Synchronize user comments - https://github.com/ardumont/org-trello/issues/86
- [ ] More fined grained use of the trello api (retrieve only data we use) - https://github.com/ardumont/org-trello/issues/69
- [ ] Use trello labels and org tags as one - https://github.com/ardumont/org-trello/issues/70
- [ ] Another Disposition about org's buffer - https://github.com/ardumont/org-trello/issues/33
- [ ] Improve sync request policy - https://github.com/ardumont/org-trello/issues/58
- [ ] Test multiple emacs version - https://github.com/ardumont/org-trello/issues/52
- [ ] One command to sync them all - https://github.com/ardumont/org-trello/issues/59
- [ ] Expose a public trello board showing the status of org-trello and reference it inside the release notes
...
- [ ] Improve tests coverage - some major and important functionalities are not covered (due at time of ignorance on how to do it, there is only so much one can do!
* TODO Template [0%]
- [ ] Backlog
- [ ] Version
- [ ] Update doc
...
** Adding member
- during the card creation (POST request), idMembers request is a request param (list of comma-separated list of member id)
- during the card update (PUT request), idMembers is a request param (list of comma-separated list of member id)
- update directly the card with member via PUT /cards/id/idMembers=1,2,3
- GET -> idMembers in a card is a list of member ids
