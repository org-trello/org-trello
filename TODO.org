...
** TODO Improve the current attach board and list routine to avoid manual setup for the user
** TODO End to end tests (hint: ecuke)
...
** TODO Implement org's standard checklist http://orgmode.org/manual/Checkboxes.html
* Questions
