...
- [ ] Improve the proxy requesting multiple entities multiple times for the same entity on trello (multiple results in remote)
- [ ] Remove org-trello bindings when org-trello's minor mode is switched off.
- [ ] Release notes
- [ ] Update version
- [ ] Release
* TODO 0.3.0 [0%]
