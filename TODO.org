...
** TODO Improve the synchronous creation of cards (and sub-elements...) of to avoid the blocking
** TODO Delete [0%]
*** TODO card
*** TODO checklist
*** TODO task
...
** TODO Look at the request package from the melpa repository
If the submodule is useless, remove emacs-request and install the other one
