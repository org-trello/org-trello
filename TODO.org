...
CLOSED: [2013-08-14 mer. 16:57]
** TODO Fix the loss of todo keywords after the synchronization -> no idea what's wrong here
** TODO Improve the attachment board routine to add the missing | keyword (hardcode with DONE for example)
