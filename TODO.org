...
- [ ] #256 - one user can have multiple trello accounts
...
- [ ] Create backlog
- [ ] Update version
- [-] #238 - [internal] Respect elisp coding conventions [1/3]
  - [X] Rename constants + variables
  - [ ] Rename entry point using emacs lisp's conventions + alias old definition
  - [ ] Fix access key + consumer key loading
- [ ] #239 - Migrate ~/.trello/config.el inside user-emacs-directory
- [ ] Release notes
