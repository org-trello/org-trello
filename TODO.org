...
CLOSED: [2013-08-25 dim. 15:43]
* TODO 0.1.6 [0%]
- [-] Use the native org checklist to sync to trello [1/3]
  ...
  - [ ] Set the metadata information on the checklist level (org does only the heading level)
  - [ ] Ensure the synchronization works
