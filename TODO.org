...
- [ ] Release notes
* IN-PROGRESS 0.2.3 [80%]
- [X] Version
- [X] Fix discrepancy between docstring and binding to delete the setup.
- [X] Use a prefix binding which does not override the emacs's default user prefix (keep the original for the moment to avoid disturbing people which already use it)
