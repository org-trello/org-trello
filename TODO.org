...
** DONE Refactoring the http and http-sync method
CLOSED: [2013-08-06 mar. 16:10]
** TODO Improve the delete entity action by forcing the caret to go at the begin of the line before killing anything.
** TODO Update version
** TODO release notes
** TODO Release on marmalade/melpa
* TODO v0.1.0 [%]
