...
- [X] Version
- [X] Release notes
* IN-PROGRESS 0.4.3 [16%]
- [X] Prepare backlog
- [-] Replace local back-end (file implementation) with a RAM database [83%]
...
- [ ] Improve start/stop server policy (one server may sync multiple boards... and right now, not taken into account)
- [ ] Clean dead code from the implementation from disk files to RAM db
- [ ] Version
- [ ] Release notes
* TODO 0.4.x [0%]
