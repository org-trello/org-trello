...
* IN-PROGRESS 0.7.1 [20%]
- [X] Update version
- [ ] #272 - Use native completion mechanism
- [ ] #273 - Fix color labels
- [ ] #271 - Make a user option for user to decide the policy about checksum and position
- [ ] Release notes
* DONE 0.7.0 [100%]
