...
* IN-PROGRESS 0.3.6 [50%]
- [X] Test multiple emacs version - https://github.com/org-trello/org-trello/issues/52
- [X] Add a logo to website - https://github.com/org-trello/org-trello/issues/129
- [-] Synchronize user comments - https://github.com/org-trello/org-trello/issues/86
  - [X] Retrieve the last 5 comments
  - [X] Write the last 5 comments
  - [ ] Make the org-trello parsing routine aware of comments (even if not used, for symmetry's sake)
  - [ ] Routine for the user to see the last 5 comments
  - [ ] Routine to add a comment (with sync to trello)
  - [ ] Write the new comment locally
