...
* IN-PROGRESS Development steps [76%] :orgtrello-id-51d18669dbb4f4076b001bde:
...
** DONE Depending on the level, trigger the right api call :orgtrello-id-51d1df7779592bc71c000cd9:
...
** IN-PROGRESS Advanced creation (cf. org-get-entry) [0%]
*** IN-PROGRESS level 2 - create/update trello checklist + any tasks associated to the checklist
