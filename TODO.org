...
** TODO For the saving of the buffer after the synchronization is done (after all we write the trello ids in the buffer)
* TODO v0.0.8 [0%]
** TODO Look to the org-mode's standard checklist http://orgmode.org/manual/Checkboxes.html
