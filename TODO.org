...
- [-] Clean dead code from the implementation switch from implicit disk files db to RAM db [33%]
  - [X] Clean dead code - Round 1
  - [ ] Clean dead code - Round 2
  - [ ] Clean dead code - Round 3
- [ ] Version
- [ ] Release notes
* TODO 0.4.x [0%]
