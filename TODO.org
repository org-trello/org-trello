...
* IN-PROGRESS 0.5.3 [50%]
- [X] Backlog
- [-] Emacs blocks when sync - #164 - Deferred the sync/delete actions [50%]
  ...
  - [ ] Cleanup dead code
  - [ ] Trigger save after sync action
  - [ ] Caret must remain where it stands after sync from action
...
- [X] Remove dead code
- [-] Refactor behavior between sync card and sync buffer [%]
  - [X] Refactor behavior
  - [ ] Refactor names
- [ ] Update version
- [ ] Release notes
