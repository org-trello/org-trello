...
- [ ] Use defcustom instead of defvar for user customisation - [[https://github.com/org-trello/org-trello/issues/196][#196]]
...
* IN-PROGRESS 0.5.8 [20%]
- [X] Backlog
- [ ] Update version
- [ ] Add emacs24 dependencies
- [ ] Downgrade request dependency to 0.3.1 to make org-trello installation in melpa-stable -
- [ ] Release notes
* DONE 0.5.7 [100%]
