...
- [-] Add a comment to a card - https://github.com/org-trello/org-trello/issues/132
  - [X] Open the api to add a comment to a card
  - [ ] Add an interactive command to add a comment (with sync to trello)
  - [ ] Add a binding to the 'add a comment' command
  - [ ] Update the current comment list locally
