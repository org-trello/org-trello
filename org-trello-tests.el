...
(expectations (desc "testing orgtrello-data/--get-metadata")
...
(expectations (desc "orgtrello-api/move-card - 1")
...
(expectations (desc "orgtrello-api/move-card - 2")
...
(expectations (desc "orgtrello-api/move-card - 3")
...
(expectations (desc "orgtrello-api/move-card - 4")
...
(expectations (desc "orgtrello-api/move-card - 5")
...
(expectations (desc "orgtrello-api/move-card - 6")
...
(expectations (desc "orgtrello/--compute-state-from-keyword")
...
(expectations (desc "orgtrello/--item-compute-state")
...
(expectations (desc "orgtrello/--item-compute-check")
...
(expectations (desc "orgtrello/--compute-marker-from-entry")
...
(expectations (desc "orgtrello/id-p")
...
(expectations (desc "orgtrello/--compute-due-date")
  (expect "DEADLINE: <some-date>
" (orgtrello/--compute-due-date "some-date"))
  (expect "" (orgtrello/--compute-due-date nil)))

(expectations (desc "orgtrello/--private-compute-card-to-org-entry")
  (expect "* name TODO
DEADLINE: <some-date>
...
(expectations (desc "orgtrello/--compute-checklist-to-orgtrello-entry")
...
(expectations (desc "orgtrello/--compute-checklist-to-org-checkbox")
  (expect "- [X] name
...
(expectations (desc "orgtrello/--compute-item-to-org-checkbox")
  (expect "- [X] name
...
(expectations (desc "orgtrello/--compute-item-to-orgtrello-entry")
  (expect "*** DONE name
" (orgtrello/--compute-item-to-orgtrello-entry "name" 3 "complete"))
  (expect "*** TODO name
" (orgtrello/--compute-item-to-orgtrello-entry "name" 3 "incomplete")))

(expectations (desc "orgtrello/--compute-checklist-to-org-entry")
  (expect "- [-] name
" (orgtrello/--compute-checklist-to-org-entry (orgtrello-hash/make-properties `((:name . "name"))) t))
  (expect "- [-] name
" (orgtrello/--compute-checklist-to-org-entry (orgtrello-hash/make-properties `((:name . "name"))) t)))

(expectations (desc "orgtrello/--compute-checklist-to-org-entry")
  (expect "** TODO name
" (orgtrello/--compute-checklist-to-org-entry (orgtrello-hash/make-properties `((:name . "name"))) nil))
  (expect "** TODO name
" (orgtrello/--compute-checklist-to-org-entry (orgtrello-hash/make-properties `((:name . "name"))) nil)))

(expectations (desc "orgtrello/--compute-item-to-org-entry - 1")
  (expect "  - [X] name
" (orgtrello/--compute-item-to-org-entry (orgtrello-hash/make-properties `((:name . "name") (:keyword . "complete"))) t))
  (expect "  - [ ] name
" (orgtrello/--compute-item-to-org-entry (orgtrello-hash/make-properties `((:name . "name") (:keyword . "incomplete"))) t)))

(expectations (desc "orgtrello/--compute-item-to-org-entry - 2")
  (expect "*** DONE name
" (orgtrello/--compute-item-to-org-entry (orgtrello-hash/make-properties `((:name . "name") (:keyword . "complete"))) nil))
  (expect "*** TODO name
" (orgtrello/--compute-item-to-org-entry (orgtrello-hash/make-properties `((:name . "name") (:keyword . "incomplete"))) nil)))
...
(expectations (desc "orgtrello/--compute-state-generic")
...
(expectations (desc "orgtrello/--card")
...
(expectations (desc "orgtrello/--card-delete")
...
(expectations (desc "orgtrello/--compute-next-card-point")
  (expect 50
    (with-temp-buffer
      (insert "* heading\n")
      (insert "- [ ] some checklist\n")
...
(expectations (desc "orgtrello/--dispatch-create-entities-map-with-adjacency")
...
(expectations (desc "orgtrello/--init-map-from")
...
(ert-deftest testing-orgtrello/--merge-item ()
  (should (hash-equal #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8 data (:name "some name" :keyword "TODO" :id nil :level 3))
                      (orgtrello/--merge-item (orgtrello-hash/make-properties `((:checked . "anything") (:name . "some name")))
                                              (orgtrello-hash/make-properties `((:name . "some other name") (:keyword "TODO"))))))
  (should (hash-equal #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8 data (:name "some name" :keyword "DONE" :id nil :level 3))
                      (orgtrello/--merge-item (orgtrello-hash/make-properties `((:checked . "complete") (:name . "some name")))
                                               nil)))
  (should (hash-equal #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8 data (:name "some name" :keyword "TODO" :id nil :level 3))
                      (orgtrello/--merge-item (orgtrello-hash/make-properties `((:checked . "anything") (:name . "some name")))
  ...
  (should (hash-equal #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8 data (:name "some name" :keyword "TODO" :id "1" :level 3))
                      (orgtrello/--merge-item (orgtrello-hash/make-properties `((:checked . "anything") (:name . "some name") (:id . "1")))
                                              (orgtrello-hash/make-properties `((:name . "some other name") (:keyword . "TODO"))))))
  (should (hash-equal #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8 data (:name "some name" :keyword "TODO" :id "1" :level 3))
                      (orgtrello/--merge-item (orgtrello-hash/make-properties `((:checked . "anything") (:name . "some name") (:id . "1")))
  ...
  (should (hash-equal #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8 data (:name "some name" :keyword "DONE" :id "1" :level 3))
                      (orgtrello/--merge-item (orgtrello-hash/make-properties `((:checked . "complete") (:name . "some name") (:id . "1")))
                                              nil))))
...
(ert-deftest testing-orgtrello/--merge-checklist ()
  (should (hash-equal #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8 data (:name "some name" :id nil :level 2))
                      (orgtrello/--merge-checklist (orgtrello-hash/make-properties `((:id . nil) (:name . "some name")))
  ...
  (should (hash-equal #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8 data (:name "some name" :id "1" :level 2))
                      (orgtrello/--merge-checklist (orgtrello-hash/make-properties `((:id . "1") (:name . "some name") (:id . "1")))
                                                   (orgtrello-hash/make-properties `((:name . "some other name"))))))
  (should (hash-equal #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8 data (:name "some name" :id "1" :level 2))
                      (orgtrello/--merge-checklist (orgtrello-hash/make-properties `((:id . "1") (:name . "some name") (:id . "1")))
  ...
  (should (hash-equal #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8 data (:name "some name" :id "1" :level 2))
                      (orgtrello/--merge-checklist (orgtrello-hash/make-properties `((:id . "1") (:name . "some name") (:id . "1")))
                                                   (orgtrello-hash/make-properties `((:name . "some other name"))))))
  (should (hash-equal #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8 data (:name "some name" :id "1" :level 2))
                      (orgtrello/--merge-checklist (orgtrello-hash/make-properties `((:id . "1") (:name . "some name")))
                                                   nil))))
...
(expectations (desc "orgtrello/--compute-user-properties")
...
(expectations (desc "orgtrello/--list-user-entries")
 (expect
...
(expectations (desc "orgtrello/--csv-user-ids-to-csv-user-names")
...
(expectations (desc "orgtrello/compute-property")
...
(expectations (desc "orgtrello-data/--deal-with-value")
  (expect "abc"        (orgtrello-data/--deal-with-value "abc"))
  (expect '()          (orgtrello-data/--deal-with-value []))
  (expect '(1 2 3)     (orgtrello-data/--deal-with-value [1 2 3]))
  (expect nil          (orgtrello-data/--deal-with-value :json-false))
  (expect 1            (orgtrello-data/--deal-with-value 1))
  (expect :k           (orgtrello-data/--deal-with-value :k))
  (expect "complete"   (orgtrello-data/--deal-with-value "complete"))
  (expect "incomplete" (orgtrello-data/--deal-with-value "incomplete"))
  (expect t            (orgtrello-data/--deal-with-value t)))
...
(ert-deftest testing-orgtrello-data/from-trello-with-list-of-results ()
  (let ((list-hash (orgtrello-data/from-trello '[((shortUrl . "https://trello.com/b/o9oY3NlQ")
                                                 ...
                                                 ((shortUrl . "https://trello.com/b/xzOJmxzy")
                                                  ...
                                                  (subscribed . :json-false)
                                                  (shortLink . "xzOJmxzy")
                                                  (memberships . [((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "admin")
                                                                   (idMember . "4f43af78db54d8d36a9cec55")
                                                                   (id . "50aa59502ddab2fc1100115f"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "4f96d90f255397e90d0a79af")
                                                                   (id . "50ac97229d72f8505000a877"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "4f3e9191c8a1ac81700bd431")
                                                                   (id . "50af99de8d8b58c420006ab6"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "4fc5e74b3f25b1e64ba62ae5")
                                                                   (id . "50af99de8d8b58c420006aba"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "admin")
                                                                   (idMember . "4f2baf18746b593a3f036c98")
                                                                   (id . "50af99defb2d21a73c01afe0"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "4f2a533b89c9bdd9360ce4e0")
                                                                   (id . "50af99de8d8b58c420006abe"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "4ec96b888208a4133d62f3e2")
                                                                   (id . "50af99defb2d21a73c01afe4"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "admin")
                                                                   (idMember . "4f2f9ac39d30afb259033926")
                                                                   (id . "50af99de8d8b58c420006ac2"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "4fa141692758fd2d7b072bf3")
                                                                   (id . "50af99de8d8b58c420006ac6"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "505c3948c5e10bf70c3e3934")
                                                                   (id . "50af99de33827a7c67006783"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "4fa29db0c1c0ef57031587dc")
                                                                   (id . "50af99de39539aec200052d6"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "5085039ac1f6e4201b002281")
                                                                   (id . "50af99df2602fdef320178cd"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "admin")
                                                                   (idMember . "4f1541451c3e304f5b012b40")
                                                                   (id . "50af99dffb2d21a73c01afe8"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "50acf523ae4d62a632015df2")
                                                                   (id . "50af9bc2ae4d62a63201d8d9"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "4f2baa2f72b7c1293501cad3")
                                                                   (id . "50b5ee6b4d4411007100500a"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "4f2bb113204d58923704ada3")
                                                                   (id . "50b5fde82ce5a9b24f00123d"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "4f2fce0b73c9e4eb24a3ab68")
                                                                   (id . "50b74827e77a1e39180022f4"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "4f2baf9c72b7c1293503ad94")
                                                                   (id . "50bc634b1daa0b6e5201cdad"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "4f2bb0137f2255281b2e0778")
                                                                   (id . "50bf5ed23983b96a3e0078c8"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "4f560f319dd98bbf302ccb43")
                                                                   (id . "516c0223161d8f0314006b4e"))
                                                                  ((unconfirmed . :json-false)
                                                                   (deactivated . :json-false)
                                                                   (memberType . "normal")
                                                                   (idMember . "516c00f1e1241bfd600083db")
                                                                   (id . "516c02240a36554365004429"))])
                                                  (invitations . [])
                                                  (prefs
                                                   (canInvite . t)
                                                   (canBePrivate . t)
...
;;                        ((pos . 49152)
;;                         (nameData)
;;                         (name . "Ch. 2 - First steps in scala")
;;                         (id . "52c0b5396a5b853501059af3")
;;                         (state . "incomplete"))
;;                        ((pos . 65536)
;;                         (nameData)
;;                         (name . "Ch. 3 - Next steps in scala")
;;                         (id . "52c0b53a77dafa586103e3a9")
;;                         (state . "incomplete"))
;;                        ((pos . 81920)
;;                         (nameData)
;;                         (name . "Ch. 4 - Classes and objects")
;;                         (id . "52c0b53beeda68542c021079")
;;                         (state . "incomplete"))
;;                        ((pos . 98304)
;;                         (nameData)
;;                         (name . "Ch. 5 - Basic types and operations")
;;                         (id . "52c0b53c431ab6990a0441d7")
;;                         (state . "complete"))
;;                        ((pos . 114688)
;;                         (nameData)
;;                         (name . "Ch. 6 - Functional objects")
;;                         (id . "52c0b53d0a93c6084404c95f")
;;                         (state . "incomplete"))
;;                        ((pos . 131072)
;;                         (nameData)
;;                         (name . "Ch. 7 - Buit-in control structures")
;;                         (id . "52c0b53e24346d4131026645")
;;                         (state . "incomplete"))
;;                        ((pos . 147456)
;;                         (nameData)
;;                         (name . "Ch. 8 - Functions and closures")
;;                         (id . "52c0b53ff6a939a72e023608")
;;                         (state . "complete"))
;;                        ((pos . 163840)
;;                         (nameData)
;;                         (name . "Ch. 9 - Control abstraction")
;;                         (id . "52c0b54057c0da4f7404a602")
;;                         (state . "incomplete"))
;;                        ((pos . 180224)
;;                         (nameData)
;;                         (name . "Ch. 10 - Composition and inheritance")
;;                         (id . "52c0b5417cdc75506a050774")
;;                         (state . "incomplete"))
;;                        ((pos . 196608)
;;                         (nameData)
;;                         (name . "Ch. 11 - Scala's hierarchy")
;;                         (id . "52c0b5421b88b55c43001692")
;;                         (state . "incomplete"))
;;                        ((pos . 212992)
;;                         (nameData)
;;                         (name . "Ch. 12 - Traits")
;;                         (id . "52c0b54235e5cdc562004866")
;;                         (state . "incomplete")))
;;                :card-id "52c0b529bdbf2ab3770570b7"
;;                :board-id "51d99bbc1e1d8988390047f2"
;;                :name "chapters"
;;                :id "52c0b52ece09f28f6801fe5e"
;;                :level 2))
