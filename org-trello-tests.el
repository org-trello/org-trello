...
(ert-deftest testing-orgtrello-api/get-tasks ()
  (let ((h (orgtrello-api/get-tasks :checklist-id)))
    (should (equal (gethash :method h) :get))
    (should (equal (gethash :uri    h) "/checklists/:checklist-id/checkItems/"))))

(ert-deftest testing-orgtrello/--do-retrieve-checklists-and-items ()
  (let ((orgtrello/--checklist '((checkItems . [((pos . 16384)
                                                 (name . "yes")
                                                ...
                                                ((pos . 49152)
                                                 ...
                                                 (state . "incomplete"))]))))
    (should (equal (orgtrello/--do-retrieve-checklists-and-items orgtrello/--checklist) '(((pos . 16384)
                                                                                           (name . "yes")
                                                                                           (id . "51da82abf4deb8010b003850")
                                                                                           (state . "incomplete"))
                                                                                          ((pos . 32768)
